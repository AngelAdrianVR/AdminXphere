<template>
  <AppLayout title="Internos y Generales">
    <template #header>
      ...
      <div class="max-w-7xl mx-auto lg:px-8">
        <div class="lg:grid grid-cols-3 gap-10">
          <Link :href="route('general.documents')">
            <div
              class="flex flex-col text-center text-gray-500 hover:text-green-600 mt-10 rounded-lg border-2 border-gray-200 hover:border-green-600 px-2 py-2 mb-3 transition ease-in-out"
            >
          ...
          <Link :href="route('general.guard-house-chat')">
            <div
              class="flex flex-col text-center mt-10 text-gray-500 hover:text-green-600 rounded-lg border-2 border-gray-200 hover:border-green-600 px-2 py-2 mb-3 transition ease-in-out"
            >
          ...
          <Link :href="route('general.report-incident')">
            ...
            >
              ...
              <p class="my-2">Reportes de incidentes</p>
            </div>
          </Link>
